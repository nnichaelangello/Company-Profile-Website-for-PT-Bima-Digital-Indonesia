  ...
  return (
    <header className="bg-white py-5 shadow-[0_2px_15px_rgba(0,0,0,0.05)] sticky top-0 z-[1000]">
      <div className="container mx-auto max-w-[1280px] px-5 flex items-center justify-between">
        ...
        <nav className={isNavActive ? 'active' : ''}>
          <ul className="flex">
            <li>
              <Link
                href="/"
                className="text-[#2D3748] text-[15px] font-medium hover:text-[#D4AF37] hover:-translate-y-[2px] transition-all duration-300 ease-in-out"
              >
                Home
              </Link>
            </li>
        ...
        <button
          className="hamburger md:hidden text-[#1E3A8A] text-[24px]"
